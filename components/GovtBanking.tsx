    ...
    <div className="bg-[#FFF1EC] ">
      <Container>
        <div className="flex flex-row  mb-20">
          {/* Header Text */}
          <div className=" flex flex-col gap-30  mt-20  w-fit justify-center mr-auto">
            ...
            {/* Carousel Texts */}
            <div className="flex flex-row w-100 gap-7">
              ...
              <div className="flex flex-col  w-100 gap-14 cursor-pointer">
          ...
          <div className="mt-110  w-full flex 2xl:justify-center">
            <img
