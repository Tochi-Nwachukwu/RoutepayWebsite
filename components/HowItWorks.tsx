...
export default function HowItWorks({ animate, header, title }: HowItWorksProps) {
  return (
    <div className="container mx-auto font-light mt-12 px-5 xl:px-0 flex flex-col lg:flex-row gap-4">
      <Container>
        <div className="flex flex-col gap-30">
          ...
          <div className="grid grid-cols-3 gap-17.75">
              ...
              return (
                <div className="flex flex-col gap-8" key={index}>
                  <div className="flex flex-col gap-4">
                    ...
                    <h3 className="font-normal text-[24px] text-black">{item.header}</h3>
