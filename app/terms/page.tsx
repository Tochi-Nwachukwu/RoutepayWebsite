      ...
      <div className="max-w-[1231px] mx-auto">
        ...
        <div className="mt-[60px] pb-32 xl:pb-[315px] text-[#4D4A4A]">
          <p>
            ...
            at customersupport@routepay.com , or by mail to Plot 1679 Karimu Kotun
          ...
          <p>
            ...
            please address your request to: customersupport@routepay.com . If we ever
          ...
          <p>
            ...
            Nigeria <br />
            customersupport@routepay.com   <br />
          </p>
        </div>
      </div>
    </div>
