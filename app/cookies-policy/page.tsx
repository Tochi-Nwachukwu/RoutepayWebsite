      ...
      <div className="max-w-[1231px] mx-auto">
        ...
        <div className="mt-[60px] pb-32 xl:pb-[315px] text-[#4D4A4A]">
          ...
          <ul className="list-disc list-inside">
            ...
            <li>How you can manage your cookie preferences</li>
          </ul>
          <br />
          <p>
            By using our website, you consent to the use of cookies in
            accordance with this policy, unless you have disabled them.
            <br />
            <br />
          </p>
          ...
          <br />
          <ul className="list-disc list-inside">
            <li>Web beacons (track page visits)</li>
            <li>Local Storage (store larger data than cookies) </li>
          ...
          <p>We allow trusted partners to set cookies for:</p>
          <br />
          <ul className="list-disc list-inside">
            <li>Analytics (Google, Hotjar) </li>
            <li>Advertising (Facebook, LinkedIn) </li>
            <li>Social Media (Twitter, YouTube)</li>
          </ul>
          <br />
          <p>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              Adjust preferences anytime via our Cookie Settings link in the
              footer.{" "}
            </li>
          </ul>
          <br />
          ...
          <br />
          <ul className="list-disc list-inside">
            <li>Changes in cookie technologies </li>
            <li>New legal requirements (e.g., NDPC)</li>
            <li>Shifts in business practices </li>
          </ul>
          <br />
          <p>
