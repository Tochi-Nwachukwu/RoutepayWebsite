    ...
    <div className="bg-[#F5EDED] px-5 font-light">
      <div className="max-w-[1231px] mx-auto">
        ...
        <div className="mt-[60px] pb-32 xl:pb-[315px] text-[#4D4A4A]">
          <p>
            Routelink Integrated Systems Limited (“the Company”) is committed to
            protecting the privacy and security of personal data in compliance
            with the Nigeria Data Protection Commission (NDPC), the Nigeria Data
            Protection Act (NDPA) 2023, and other applicable laws. This policy
            outlines how we collect, process, store, and safeguard personal data
            belonging to customers, employees, partners, and vendors
            <br />
            <br />
          </p>
          ...
          <ul className="list-disc list-inside">
            <li>Customers (subscribers, users, prospective clients)</li>
            <li>Employees (current, former, job applicants) </li>
            <li>Partners & Vendors (third-party service providers)</li>
            <li>Any individual whose data we process </li>
          </ul>
          <br />
          <p>
            It covers all forms of data handling, including collection, storage,
          ...
          <p>We process data based on at least one of the following: </p>
          <br />
          <ul className="list-disc list-inside">
            <li>Consent (freely given and withdrawable) </li>
            <li>Contractual necessity (to provide services) </li>
            <li>Legal obligation (required by law) </li>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>Delete data (where applicable)</li>
            <li>Restrict or object to processing </li>
            <li>Data portability (if feasible) </li>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>Data is only shared when necessary and lawful. </li>
            <li>
          ...
          <ul className="list-disc list-inside">
            <li>Report breaches to the DPO within 24 hours. </li>
            <li>
          ...
          <br />
          <ul className="list-disc list-inside">
            <li>New laws are enacted. </li>
            <li>Major changes in data processing occur.</li>
          ...
          <ul className="list-disc list-inside">
            <li>
              Violations may lead to disciplinary action, termination, or legal
              consequences.{" "}
            </li>
          ...
          <p>
            For data requests or concerns, contact: <br />
            Routelink Integrated Systems Limited <br />
            Email: info@routelinktel.com <br />
            Phone: (+234)8030905494, (+234)8038190914, (+234)8036288832 <br />
          </p>
        </div>
      </div>
    </div>
